    ...
    >
      <div className="flex items-center justify-between h-[60px] px-6 md:px-[48px] max-w-[1400px] mx-auto">
        ...
        <a href="#" className="flex items-center gap-[10px] shrink-0 group">
          <span className="w-[10px] h-[10px] bg-[#FFD400] group-hover:scale-110 transition-transform" />
          ...
          {links.map(({ label, section }) => {
            ...
            return (
              <button
                ...
                style={{ color: isActive ? "#FFD400" : "#555" }}
                onMouseEnter={(e) => {
              ...
              >
                {label}
                <span
                  className="absolute left-0 -bottom-[3px] h-[1.5px] bg-[#FFD400] transition-all duration-300"
        ...
        <div className="hidden md:flex items-center gap-[14px]">
          ...
          <a
            href="#"
            className="font-grotesk text-[11px] font-bold text-[#050505] bg-[#FFD400] tracking-[1.5px] px-[18px] py-[9px] hover:bg-[#F5F5F0] transition-colors"
          >
            VIEW DEMO
          </a>
        </div>
      ...
      >
        <nav className="flex flex-col px-6 py-5 gap-0">
          {links.map(({ label, section }) => {
            ...
            return (
              <button
                ...
                style={{ color: isActive ? "#FFD400" : "#666" }}
              >
                <span
                  className="w-[4px] h-[4px] rounded-full shrink-0 transition-colors"
                  style={{ background: isActive ? "#FFD400" : "#2D2D2D" }}
                />
                {label}
              </button>
            );
          ...
          <div className="flex flex-col gap-[10px] pt-5">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="font-ibm-mono text-[12px] text-[#555] tracking-[1.5px]">GITHUB</a>
            <a
              href="#"
              className="font-grotesk text-[11px] font-bold text-[#050505] bg-[#FFD400] tracking-[1.5px] px-[18px] py-[11px] text-center hover:bg-[#F5F5F0] transition-colors"
            >
              VIEW DEMO
            </a>
          </div>
